...
namespace not_hesaplama
{
    public partial class frm2 : Form
    {
        ...
        {
            double average, mPercent, fPercent, midterm, final;
            try
            {
                midterm = Convert.ToDouble(numericUpDown1.Value);
                final = Convert.ToDouble(numericUpDown2.Value);
                mPercent = double.Parse(comboBox1.Text.Trim(new Char[] { '%' }));
                fPercent = double.Parse(comboBox2.Text.Trim(new Char[] { '%' }));

                if (midterm > 100) MessageBox.Show("Vize Notu Hatalıdır, Lütfen 0 ile 100 Arasında Bir Değer Giriniz!");
                else if (final > 100) MessageBox.Show("Final Notu Hatalıdır, Lütfen 0 ile 100 Arasında Bir Değer Giriniz!");
                else if (mPercent > 99) MessageBox.Show("Vize Yüzdesi Hatalı Lütfen 0 ile 100 Arasında Bir Değer Giriniz!");
                else if (fPercent > 99) MessageBox.Show("Final Yüzdesi Hatalı Lütfen 0 ile 100 Arasında Bir Değer Giriniz!");
                else if (mPercent + fPercent != 100) MessageBox.Show("Vize ve Final Yüzde Toplamı 100 Olmalıdır Lütfen Düzeltiniz!");
                else
                {
                    average = midterm / 100 * mPercent + final / 100 * fPercent;
