    ...
    public partial class frm3 : Form
    {
        ...
        private void process()
        {
            ...
            try
            {
                ...
                but = Convert.ToDouble(numericUpDown2.Value);
                ...
                else if (bPercent > 99) MessageBox.Show("Büt Yüzdesi Hatalı Lütfen 0 ile 100 Arasında Bir Değer Giriniz!");
                else if (mPercent + bPercent != 100) MessageBox.Show("Vize ve Büt Yüzde Toplamı 100 Olmalıdır Lütfen Düzeltiniz!");
                else
                {
        ...
        private void frm3_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void frm3_KeyPress(object sender, KeyPressEventArgs e)
        {
